...
-(NSString *)imei
{
    NSString *imei = [[NSUserDefaults standardUserDefaults] objectForKey:@"SH_IMEI_KEY"];
    
    if (imei==nil || [imei isEqualToString:@""])
    {
        imei = [SSUUID uniqueID];
        imei = (imei==nil)?@"":imei;
        [[NSUserDefaults standardUserDefaults] setValue:imei forKey:@"SH_IMEI_KEY"];
