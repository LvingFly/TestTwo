...
//    [[self.navigationBar.subviews firstObject] insertSubview:self.navColorOverly atIndex:0];
    [self.navigationBar setTranslucent:YES];
...
//            _navColorOverly.frame=CGRectMake(0, -20, self.navigationBar.frame.size.width, SA_NAVBAR_HEIGHT_WITH_STATUS_BAR);
...
{
    [self.navigationBar lt_setBackgroundColor:cl];
...
//    navBottomLine.backgroundColor = [UIColor clearColor];
