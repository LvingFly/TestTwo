...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.backgroundColor = SA_Color_HexString(0xf5f5f5, 1);
        ...
        btn.layer.borderColor = SA_Color_HexString(0x5f646e, 1).CGColor;
        btn.layer.borderWidth = 1.0;
        btn.backgroundColor = [UIColor clearColor];
        [btn setTitleColor:SA_Color_HexString(0x5f646e, 1) forState:(UIControlStateNormal)];
        [btn sizeToFit];
        ...
        [label setTextColor:SA_Color_HexString(0x363a3c, 1)];
