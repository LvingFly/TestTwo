...
static NSString* const  kCellIdentifier = @"PMCircleCellIdentifier";

@interface PMCircleCollectionView ()<UICollectionViewDelegate,UICollectionViewDataSource,UIScrollViewDelegate>
...
@implementation PMCircleCollectionView
...
- (void)setImageArray:(NSArray *)imageArray {
    [self setImageArray:imageArray perPageCount:self.perPageCount];
}
...
- (void)initUIWithFrame:(CGRect)frame
{
    ...
    [_collectionView registerClass:self.cellClass ? self.cellClass : [PMCircleCollectionViewCell class]  forCellWithReuseIdentifier:kCellIdentifier];
...
- (void)reSetUrlImageArrayWith:(NSArray *)urlImageArray perPageCount:(NSInteger)perPageCount
{
    ...
    if (perPageCount == 1) {
        ...
        self.urlImageArray = [NSMutableArray arrayWithArray:array];
...
- (void)reSetLocalImageArray:(NSArray *)localImageArray perPageCount:(NSInteger)perPageCount
{
    if (perPageCount == 1) {
        ...
        self.localImageArray = [NSMutableArray arrayWithArray:array];;
        _totalPage = array.count / perPageCount;
        return;
    }
...
{
    return self.urlImageArray.count > 0 ? self.urlImageArray.count : self.localImageArray.count;
}

- (UICollectionViewCell*)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    PMCircleCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:kCellIdentifier forIndexPath:indexPath];
    ...
    if (self.urlImageArray.count > 0) {
        ...
        cell.imageView.image = self.localImageArray[indexPath.row];
    }
...
- (void)setCellClass:(Class)cellClass
{
    ...
    if ([cellClass isSubclassOfClass:[PMCircleCollectionViewCell class]]) {
