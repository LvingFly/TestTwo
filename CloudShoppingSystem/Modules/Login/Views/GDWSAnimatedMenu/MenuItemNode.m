...
+ (instancetype)menuNode
{
    ...
    [menuNode setPath:CGPathCreateWithRoundedRect(CGRectMake(0, 0, 76 * SA_SCREEN_SCALE, 76 * SA_SCREEN_SCALE), 38 * SA_SCREEN_SCALE, 38 * SA_SCREEN_SCALE, nil)];
    menuNode.strokeColor = menuNode.fillColor = [UIColor colorWithHexString:@"#ffcd00"];
    return menuNode;
}
